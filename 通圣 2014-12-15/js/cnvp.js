...
function IndBox0Init(){
	var pageid,pagetotal;
	pagetotal = Math.ceil($("#IndBox0 li").length / 5);
	if(pagetotal > 1){
		pageid = 0;
		arrow();
		$("#IndBox0 ul").width($("#IndBox0 li").length * 200);
	}
	function move(action){
		...
		$("#IndBox0 ul").animate({left:-pageid*1000},1000,"easeInOutQuart");
		arrow();
	}
	function arrow(){
		if(pageid >= (pagetotal-1)){
			$("#IndBox0 h2").css("cursor","default");
			$("#IndBox0 h2").unbind("click");
			$("#IndBox0 h2").unbind("hover");
			$("#IndBox0 h2").css("background-position","0px 0px");
		}else{
			$("#IndBox0 h2").css("cursor","pointer");
			$("#IndBox0 h2").click(function(){move(1);});
			$("#IndBox0 h2").hover(function(){$(this).css("background-position","0px 0px");},function(){$(this).css("background-position","0px 0px");});	
		}
		if(pageid <= 0){
			$("#IndBox0 h1").css("cursor","default");
			$("#IndBox0 h1").unbind("click");
			$("#IndBox0 h1").unbind("hover");
			$("#IndBox0 h1").css("background-position","0px 0px");
		}else{
			$("#IndBox0 h1").css("cursor","pointer");
			$("#IndBox0 h1").click(function(){move(-1);});
			$("#IndBox0 h1").hover(function(){$(this).css("background-position","0px 0px");},function(){$(this).css("background-position","0px 0px");});	
		}
	}
}
